...
interface ChildProfileDao {
    ...
    @Query("UPDATE child_profiles SET numeracy_level = :level WHERE id = :id")
    suspend fun updateNumeracyLevel(id: String, level: String)
...
interface SessionDao {
    ...
    suspend fun finalise(
        id: String, endedAt: Long, duration: Int,
        interactions: Int, valence: Float, flags: Int, milestones: String
    )
}
